...
- **The Teacher** — I pull each person aside at the start of their shift to review recipe chits and make sure they know the steps and nutritional information.
- **The Role Model** — I jump on the line first and build the initial few orders perfectly so the team can watch how I do it.
- **The Coach** — I gather the team and ask: "What do you think is going to be the trickiest part of this during the rush?"
- **The Supporter** — I check in to see who feels anxious about the new launch and offer to take the first few orders with them.

### Question 2
**It's 12:15 PM on a Friday. The lobby is packed, the team is struggling with speed of service, and tickets are backing up. What do you do?**

- **The Teacher** — I stand at the hand-off counter to check every single lid and consistency to make sure our standards don't slip under pressure.
- **The Role Model** — I immediately jump on the toughest position, grab a scoop, and set a fast, high-energy pace for everyone to match.
...
### Question 3
**You notice a team member consistently stands around on their phone during down-time instead of preparing for the next rush. How do you handle it?**
